...
<title>Youtip! - Jasa titip menitip Online</title>
            ...
            <div class="block-icon pull-right"> <a data-target=".bs-example-modal-lg" data-toggle="modal" class="search-focus dropdown-toggle links"> <i class="fa fa-search"></i> </a>
              ...
              <div class="toplinks">
                ...
                @auth
                  ...
                  <div class="demo"><a title="Blog" href="{{ route('logout') }}"
                onclick="event.preventDefault();
                 document.getElementById('logout-form').submit();">Logout</a>
                  <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                    {{ csrf_field() }}
                </form>><span class="hidden-xs">Logout</span></a></div>
                  <!-- Header Company -->
                  @else
                  <!-- End Header Company -->
                  <div class="login"><a href="{{ route('register') }}"><span class="hidden-xs">Register</span></a></div>
